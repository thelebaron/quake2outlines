...
void DrawString (int x, int y, char *s, int alpha);
void DrawAltString (int x, int y, char *s, int alpha);	// toggle high bit
...
void CL_DefaultClientinfo (int player);
...
void V_AddStain (vec3_t org, float intensity, float r, float g, float b, float a, staintype_t type);
