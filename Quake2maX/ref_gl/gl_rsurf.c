...
void Surf_Outline (msurface_t *surfchain) //
{
	...
	//qglDepthMask (false);
	//qglClearDepth(1.0f);
	//qglDepthRange (gldepthmin, gldepthmin + 0.10f*(gldepthmax-gldepthmin));
	qglEnable(GL_DEPTH_TEST);
	qglDepthFunc(GL_LEQUAL); // partial work if GREATER
	qglDepthRange (0.08, 1.4); /* Draw underlying geometry THE KEY!! */
	//qglPolygonOffset(11, -3); 
