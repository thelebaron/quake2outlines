...
//rendered size of a font - everthing adjusts to this...

//Quake2maX
//*
#define	VERSION				"0.44"
#define GAMENAME			"Quake2maX"
#define	WINDOW_CLASS_NAME	"Quake2maX"
...
void 	Cvar_WriteUserVariables (char *path);
